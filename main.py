...
parser.add_argument('--classes_num',type=int,default=43)
parser.add_argument('--src_data',type=str,default='../../simulator/datasetA_0_5')
parser.add_argument('--tar_data',type=str,default='../../simulator/datasetB_0_5')
# model parameter
